...
SYSTEM_PROMPT = (
    ...
    "4. ANSWER WITH SUBSTANCE. If a chunk contains the specific equations, "
    ...
    "5. Use as many claims as the answer genuinely needs, no more. Each "
    ...
    "to either 'en' or 'ar'. Write your claims in that language.\n"
