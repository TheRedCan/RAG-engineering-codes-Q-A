...
SYSTEM_PROMPT = (
    ...
    "5. SUBSTANCE OR SILENCE. For 'how do I calculate X' / 'what is the "
    "value of X' / 'what does section X require' questions, first SCAN "
    "every chunk for equations, numerical values, table entries, or "
    "specific requirement text — a later-ranked chunk often holds the "
    "actual formula while earlier ones are commentary. If you find such "
    "content, your claim MUST reproduce it (symbols, numbers, or quoted "
    "requirement text). PDF extraction can scramble equations — "
    "reconstruct them from the symbols present rather than skipping. "
    "If NO chunk contains concrete content (only narrative or pointers), "
    "return an empty `claims` list. A vague summary is NOT an answer.\n"
